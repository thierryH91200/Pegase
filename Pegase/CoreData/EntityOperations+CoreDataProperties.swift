...
extension EntityTransactions {
    @objc var sectionIdentifier: String? {
        ...
        if tmp == nil {
            if let timeStamp = self.value(forKey: "dateTransaction") as? Date {
                /*
    ...
    @objc var dateTransaction: Date? {
        get {
            self.willAccessValue(forKey: "dateTransaction")
            let tmp = self.primitiveValue(forKey: "dateTransaction") as? Date
            self.didAccessValue(forKey: "dateTransaction")
            return tmp
        }
        set {
            self.willChangeValue(forKey: "dateTransaction")
            self.setPrimitiveValue(newValue, forKey: "dateTransaction")
            self.didChangeValue(forKey: "dateTransaction")
