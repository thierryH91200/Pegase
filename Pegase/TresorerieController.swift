...
final class TresorerieController: NSViewController
{
    ...
    func updateAccount () {
        ...
        if listTransactions.isEmpty == false {
            ...
            firstDate = (listTransactions.first?.dateTransaction?.timeIntervalSince1970)!
            lastDate = (listTransactions.last?.dateTransaction?.timeIntervalSince1970)!
    ...
    func updateChartData() {
        ...
        for indexSlider in minValue..<maxValue + 1 {
            ...
            while sameDate == true {
                ...
                indexDate = ( (listTransactions[index ].dateTransaction?.timeIntervalSince1970)! - firstDate ) / hourSeconds
