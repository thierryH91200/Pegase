...
//     Custom highlighted property setter because when the property changes we need to redraw and update the containing text fields.
    func setHighlighted(_ highlighted: Bool) {
        if self.isHighlighted != highlighted {
            ...
            // Inform each contained text field what type of background they will be displayed on.
            // This is how the txt field knows when to draw white text instead of black text.
