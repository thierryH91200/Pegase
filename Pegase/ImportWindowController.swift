    ...
    @IBAction func actionImport(_ sender: NSButton) {
        ...
        for data in allData {
            ...
            if headerColumn.isEmpty == false {
                ...
                entityOperation.dateTransaction = DateTransaction
            } else {
                entityOperation.dateTransaction = Date().noon
            }
            ...
            if headerColumn.isEmpty == false {
                ...
                if dateStr == "" {
                    datePointage = entityOperation.dateTransaction!
                } else {
                    datePointage = dateFormatter.date(from: dateStr)!.noon
                }
                entityOperation.datePointage = datePointage
            } else {
                entityOperation.datePointage = entityOperation.dateTransaction
            }
